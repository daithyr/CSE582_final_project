# nohup bash run_experiment.sh > logging_240510_t15.log 2>&1 &
...
parser.add_argument('--batchsize', type=int, default=32)  # 64
parser.add_argument('--seed', type=int, default=2021)
parser.add_argument('--gpu', default='0')
parser.add_argument('--bert_emb_dim', type=int, default=1024)
